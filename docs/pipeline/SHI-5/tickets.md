...
| SHI-25 | defect | qa | Low | open | engineer | init.sh: the new PIPELINE_HAS_DEPLOY_ENVS parser disagrees with gate.sh/promote.sh (an apostrophe in a trailing comment defeats a "no"; some non-"no" forms are read as no) |
